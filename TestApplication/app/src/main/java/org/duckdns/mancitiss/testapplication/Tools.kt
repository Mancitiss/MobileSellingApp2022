...
class Tools {
    companion object
    {
        ...
        fun receive_bytes_Automatically(DIS: DataInputStream): ByteArray? {
            var result: ByteArray? = null
            var temp: String? = null
            try {
                temp = receiveASCII(DIS, 2)
                var bytesize = temp.toInt(10)
                temp = receiveASCII(DIS, bytesize)
                bytesize = temp.toInt(10)
